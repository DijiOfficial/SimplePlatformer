...
void thomasWasLate::PiranhaPlant::Update()
{
    if (m_Paused) return;
...
void thomasWasLate::PiranhaPlant::OnTriggerEnter(const diji::Collider* other, const diji::CollisionInfo&)
{
    if (m_Paused) return;
...
void thomasWasLate::PiranhaPlant::OnDestroy()
{
    BaseEnemy::OnDestroy();
...
void thomasWasLate::PiranhaPlant::Kill(const bool, const bool addPoints)
{
...
void thomasWasLate::PiranhaPlant::CreateTimeLine()
{
...
void thomasWasLate::PiranhaPlant::PauseTimeline() const
{
    m_TimelinePtr->Pause();
}

void thomasWasLate::PiranhaPlant::PauseTimeline(const bool isPaused) const
{
    if (isPaused)
        m_TimelinePtr->Pause();
    else
