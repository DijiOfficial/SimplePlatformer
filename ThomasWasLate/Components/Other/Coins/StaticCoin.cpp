...
void thomasWasLate::StaticCoin::OnTriggerEnter(const diji::Collider* collider, const diji::CollisionInfo&)
{
...
void thomasWasLate::StaticCoin::HandleBumpedBehavior(const bool, const bool)
{
    if (m_IsCollected) return;
    m_IsCollected = true;
    
    mario::MarioHelpers::SpawnCoinAboveBlock(GetOwner()->GetComponent<diji::Transform>()->GetPosition() + sf::Vector2f{ 0.f, 50.f });
    Destroy();
}
