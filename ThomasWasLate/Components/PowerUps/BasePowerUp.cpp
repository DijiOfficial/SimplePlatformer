...
thomasWasLate::BasePowerUp::BasePowerUp(diji::GameObject* ownerPtr, const IPowerUp::PowerUpType powerUpType, const bool canMove, std::string pointString)
    : Component(ownerPtr)
...
void thomasWasLate::BasePowerUp::Init()
{
...
void thomasWasLate::BasePowerUp::OnTriggerEnter(const diji::Collider* other, const diji::CollisionInfo&)
{
...
void thomasWasLate::BasePowerUp::OnHitEvent(const diji::Collider*, const diji::CollisionInfo& hitInfo)
{
    // todo: use directions
...
void thomasWasLate::BasePowerUp::PlayStartAnimation()
{
...
void thomasWasLate::BasePowerUp::OnPickup(const diji::Collider* other) const
{
