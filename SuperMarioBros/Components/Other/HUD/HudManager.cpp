...
superMarioBros::HudManager::HudManager(diji::GameObject* ownerPtr, diji::ScoreCounter* score, diji::ScoreCounter* coins, diji::ScoreCounter* timer)
    : Component{ ownerPtr }
...
void superMarioBros::HudManager::Init()
{
...
void superMarioBros::HudManager::FixedUpdate()
{
...
void superMarioBros::HudManager::Handle100CoinsCollected() const
{
    m_CoinsCounterCompPtr->Reset();
    GameManager::GetInstance().AddLife();
}

void superMarioBros::HudManager::SaveScoreAndCoins() const
{
...
void superMarioBros::HudManager::StartTimerPointCount()
{
