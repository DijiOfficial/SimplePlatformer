...
void superMarioBros::StarPower::Init()
{
    BasePowerUp::Init();
...
void superMarioBros::StarPower::OnTriggerEnter(const diji::Collider* other, const diji::CollisionInfo& hitInfo)
{
...
void superMarioBros::StarPower::OnAnimationComplete()
{
